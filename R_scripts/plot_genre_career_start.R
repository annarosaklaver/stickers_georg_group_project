...
ggsave('career_start_line.pdf', width = 20, height = 15, units = c('cm'))
...
ggsave('career_start_stacked.pdf', width = 20, height = 15, units = c('cm'))
...
ggsave('career_start_line_compare.pdf', width = 20, height = 15, units = c('cm'))
...
ggsave('career_start_stacked_compare.pdf', width = 20, height = 15, units = c('cm'))
