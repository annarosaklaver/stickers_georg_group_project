...
grouped_genres = {"Blues" : ["doo-wop", "rhythmandblues", "jazzblues", "electricblues", "soulblues", "blues", "britishblues"],
                  ...
                  "Pop" : ["brillbuilding pop", "newwavepop", "synthpop", "bubblegumdance", "eurodance", "europop", "boyband", "dancepop", "hippop", "australianpop", "girlgroup", "pop", "post-teenpop", "candypop", "viralpop", "canadianpop", "bubblegumpop", "classicukpop", "baroquepop", "sunshinepop", "latinpop", "deeppopr&b", "ukpop", "classiccountrypop", "indiepop", "acousticpop", "powerpop", "country pop", "indiepoptimism", "reggaefusion"],
